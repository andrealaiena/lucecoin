...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the lucecoin Core repository on GitHub"),
        tr("Services that claim to double your lucecoins are always ponzi schemes")
    };
