...
// Copyright (c) 2020-2023 The lucecoin Core developers
...
void PaymentServerTests::paymentServerTests()
{
    ...
    // lucecoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for lucecoin (as there is no actual maximum coins)
