...
#define QAPP_ORG_NAME "lucecoin"
#define QAPP_ORG_DOMAIN "lucecoin.org"
#define QAPP_APP_NAME_DEFAULT "lucecoin-Qt"
#define QAPP_APP_NAME_TESTNET "lucecoin-Qt-testnet"
