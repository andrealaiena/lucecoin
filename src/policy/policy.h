...
/** Recommended transaction fee by lucecoin Core developers
  *
 ...
 *
 *  lucecoin:    Increment mempool limits and accept RBF in steps of 0.0001 LUCE
...
/**
 * lucecoin: Default dust limit that is evaluated when considering whether a
...
/**
 * lucecoin: Default hard dust limit that is evaluated when considering whether
