...
const char * const BITCOIN_CONF_FILENAME = "lucecoin.conf";
const char * const BITCOIN_PID_FILENAME = "lucecoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "lucecoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/lucecoin";
#else
    // Unix
    return pathRet / ".lucecoin";
#endif
#endif
}
