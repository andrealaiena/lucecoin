...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in lucecoin v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to lucecoin values
        ...
        vSeeds.push_back(CDNSSeedData("multiLUCE.org", "seed.multiLUCE.org", true));
        vSeeds.push_back(CDNSSeedData("multiLUCE.org", "seed2.multiLUCE.org"));
