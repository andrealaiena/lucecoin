...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s lucecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lucecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lucecoin transaction") + "\n" +
              "  lucecoin-tx [options] -create [commands]   " + _("Create hex-encoded lucecoin transaction") + "\n" +
              "\n";
