...
built lucecoin Core deployments.
...
3. The feature shall call the `lucecoin_REQUIRE_EXPERIMENTAL` macro in
...
5. Inside each experimental code block, a call shall be made to the
   `lucecoin_REQUIRE_EXPERIMENTAL` macro from `support/experimental.h`, to
