...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure lucecoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure lucecoind isn't accepting b28
        ...
        #
        # lucecoin: Currently this causes a node disconnect, and I'm not even sure that's wrong.
